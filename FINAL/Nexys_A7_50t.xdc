...
set_property -dict { PACKAGE_PIN G1    IOSTANDARD LVCMOS33 } [get_ports { output_drumA1 }]; #IO_L17N_T2_35 Sch=jd[3]
set_property -dict { PACKAGE_PIN G3    IOSTANDARD LVCMOS33 } [get_ports { output_drumB1 }]; #IO_L20N_T3_35 Sch=jd[4]
